<?php
    if(isset($_POST['enviar'])){//si el botón con el name enviar es pulsado
        ...
        //guardo el contenido de cada campo en variables
            ...
            $asunto="[Faux Comunication] Has recibido un contacto de [".$nombre." ".$apellido."]";//puedo poner un input asunto o crearlo yo directamente  
            $msg="Nombre: ".$nombre."\r\n";
            ...
            $tuCasilla="info@fauxcomunication.com";
